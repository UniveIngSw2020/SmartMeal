...
public class ManagerRoomBottomNavigationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.manager_room_navigation_waiterNotifications, R.id.manager_room_navigation_tableList, R.id.navigation_notifications)
                .build();
        //val navHostFragment =
        //        supportFragmentManager.findFragmentById(R.id.navigation_host) as NavHostFragment
        //val navController: NavController = navHostFragment.navController
        supportFragmentManager.findFragmentById(R.id.navigation_host)
